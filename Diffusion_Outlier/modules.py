...
class Down(nn.Module):
    def __init__(self, in_channels, out_channels, embedding_dim) -> None:
        super().__init__()
...
class Up(nn.Module):
    def __init__(self, in_channels, out_channels, embedding_dim=256) -> None:
        super().__init__()
...
class UNet_conditional(nn.module):
    ...
    def pos_encoding(self, t, channels):
        inv_freq = 1.0 / (10000 ** (torch.arange(0.0, channels, 2.0, device=self.device) / channels))
